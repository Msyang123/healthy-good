...
public class DoctorAchievementLogService {
    ...
    public Pages<DoctorAchievementLog> pageList(DoctorAchievementLog doctorBonusLog) {
        ...
        List<DoctorAchievementLog> doctorAchievementLogs = this.doctorAchievementLogMapper.pageDoctorAchievementLogs(doctorBonusLog);
        doctorAchievementLogs.stream().filter(Objects::nonNull).map(doctorAchievementLog -> {
            doctorAchievementLog.setCommission(Objects.equals(doctorAchievementLog.getSourceType(), SourceType.SUB_DISTRIBUTOR) ?
                    doctorAchievementLog.getFruitDoctorCommission() : doctorAchievementLog.getCommission());
