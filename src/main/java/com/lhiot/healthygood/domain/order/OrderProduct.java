...
import com.lhiot.healthygood.type.RefundStatus;
...
/**
 * @author zhangshu created in 2018/9/19 9:20
 **/
@Data
@ApiModel
public class OrderProduct {
    ...
    @ApiModelProperty(notes = "商品来源Id", dataType = "Long")
    private Long sourceId;
    @ApiModelProperty(notes = "商品来源类型", dataType = "String")
